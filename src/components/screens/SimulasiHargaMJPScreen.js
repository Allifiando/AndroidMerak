...
class SimulasiHargaMJPScreen extends Component {
    constructor(props) {
        super(props);
    ...
    getUOM(lineid) {
        let api = new API();
        api.getUOM(this.state.lineid)
            .then((response) => {
                console.log('ini',response)
                this.setState({ hargamutu: '', name: '' })
                this.setState({
                    uom: [...this.state.uom, ...response.data.results],
                });
                // console.log(response)
            })
            .catch((error) => {
        ...
        return (            
            <Container>
                ...
                <SearchableDropdown
                        ...
                        onItemSelect={item => {
                            this.setState({ idplant: item.id, mutu: [] });
                ...
                <View style={styles.bottom}>
                    ...
                    <View style={{ width: '50%' }}>
                        ...
                        <NumberFormat
                            value={(Number.parseInt(this.state.hargamutu, 10) * Number.parseInt(this.state.volume, 10))}
                            displayType={'text'}
